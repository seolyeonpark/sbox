...
public class purcomplt_MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_purcomplt_main);
        ...
        layoutInflater = LayoutInflater.from(purcomplt_MainActivity.this);
        ...
        for(int i = 0; i<Soldoutlist.size(); i++) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(purcomplt_MainActivity.this, purcomplt_SecondActivity.class);
